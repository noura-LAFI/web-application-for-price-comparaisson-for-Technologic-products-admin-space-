...
<html class="no-js" >
    ...
    <body>    
                <a class="navbar-brand" href="index.html"><img    claass="w-100" src="img/log.png" alt=""></a>
   <?php 
   session_start();
    echo("<img  style=height:15px;margin-left:795px;  margin-top:20px;  width:15px; src=img/green.png alt=>"); 
   echo("  <b style= color:black; margin-left:800px; margin-top:20px;   > ".$_SESSION["nom"] ." " .$_SESSION["prenom"] ."</b>" );
   ?> 
        <div style="height: 600px;" class="preview-wrapper">
     
            <div class="switcher-body">
                <h3>Liste des autres Admins:</h3>
                <ul style="padding-left: 2px;">
                  <?php
                  $user=$_SESSION["user"];
                  $con=mysqli_connect("localhost","root","","pfa") or die (erreur);
                  $requette = " select * from utilisateur where type='admin' and username != '$user'";
                  $result = mysqli_query($con,$requette);
                  while($ligne=mysqli_fetch_array($result , MYSQLI_NUM)){
                 echo("<li> $ligne[1] $ligne[2]  </li>");
                  }            
                        ?>  
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-lg-offset-1 col-lg-10">
                                <div class="page-title text-center">
                                    <h2>Gestion<span class="primary">Bon-plan-Tech</span> <span class="title-bg">Espace Admin</span></h2>
                                </div>
                                <div class="hexagon-menu services clear">
                                    <div class="service-hex">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="gestionMag.php"><h4>Gestion <br>Magasins </h4></a>
                                        </div>
                                    </div>
                                    <div class="service-hex">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="gestionProd.php"><h4>Gestion <br> Produits</h4></a>
                                    ...
                                    <div class="service-hex">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="gestionCat.php"><h4>Gestion<br> Categories</h4></a>
                                    ...
                                    <div class="service-hex">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="gestionContacte.php"><h4>Gestion<br> Contacte</h4></a>
